...
\begin{description}
  ...
  \item[$r_c$, $r_t$, $r_n$, $e_r$, $r_x$ and $r_p$] are rewards given for each infected reach, tamarix-invaded habitat, native habitat, empty habitats, extermination of tamarix tree and restoration of native tree in empty slot, respectively.
\end{description}
