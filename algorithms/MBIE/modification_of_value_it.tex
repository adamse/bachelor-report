...
The bounds of the confidence intervals for the state-action values are calculated with equation \eqref{equation:q_upper} using these results equation \eqref{equation:vMBIE} calculates the state-values by taking the best action for each state.
