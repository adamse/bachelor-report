...
During the implementation process of the MBIE algorithm certain choices were made. These choices and their background is explained in the section below.
