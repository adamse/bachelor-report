...
\item Repeat value iteration until $V$ converges. By convergence is meant that \\$|V_{k+1} - V_{k}| \leq \epsilon$, where $\epsilon$ is chosen as a small value. 
\item At convergence, set $V = V_k$.
