% 1 Motivation
Reinforcement learning är ett område inom artificiell intelligens där
agenter använder självlärande algoritmer för att uppnå den optimala policyn för att maximera belöningen från miljön. 
Sådana algoritmer kan användas till att ta fram strategier att tackla problem i verkligheten. 
% 2 Problem statement
Denna tes har som mål att jämföra olika inlärningstekniker för algoritmer och utvärdera dessa.
