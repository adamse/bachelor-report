% 1 Motivation alt
For some problems in the real world it is infeasible to optimize behaviour by making a model and do calculations on it, in cases like these one could find good solutions by trial and error. Reinforcement learning is a way of finding optimal behavior by systematic trial and error.
