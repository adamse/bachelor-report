...
where an agent using learning algorithms tries to find an optimal behavior in a learning environment. %achieve the optimal policy for maximizing the reward. 
