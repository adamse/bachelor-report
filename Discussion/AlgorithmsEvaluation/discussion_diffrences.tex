...
\textcite{strehl2004empirical} tested the performance of the MBIE algorithm along with the \etre\ algorithm in two non factored environments, RiverSvim and Sixarms. This study clear concludes that the MBIE outperforms \etre\ in both of the environments, a result completely opposite in this study when introducing the factored representation to the \etre\ algorithm's model. 
